...
// exports.excelsheet = function (req, res) {
//   return new Promise((resolve, reject) => {
//     User.find({}, function (err, response) {
//       if (err) {        return reject(err)      }
//       if (response) {
//         var keys = Object.keys(response[0]._doc)
//         // var value1 = Object.values(response[0]._doc)
//         // console.log(value1)
//         value = [];
//         for (i = 0; i < response.length; i++) {
//           // console.log("in loop")
//           value.push('\n' + Object.values(response[i]._doc))
//         }
//         var file = keys.toString() + value.toString()
//         // convertoexcel.excelsheet1(file)
//         console.log("reslove")
//         console.log(file)
//         return resolve(file)
//       }
